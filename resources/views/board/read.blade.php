            ...
            <div class="d-flex justify-content-between">
                <div class="row w-100">
                    ...
                    <div class="col-2 d-flex justify-content-center align-items-start">
                        <favorite-board :favorite_num="{{ $board->getFavoritesCountAttribute() }}" :favorite_status="{{ $board->getFavoritedByUserAttribute() ? 'true' : 'false' }}" :board_id="{{ $board->id }}" :icon-size="54" :font-size="45"></favorite-board>
                    </div>
                </div>
            </div>
